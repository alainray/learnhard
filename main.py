...
from datasets import ImagenetCScore, CIFARIdx, get_class_weights,get_bins
...
if args.test_ds != "":
    test_data2 = data[args.test_ds](transform=preprocessing_ts, root=root, train=False if "cifar" not in args.test_ds else True, download=True)
...
for epoch in range(1, n_epochs + 1):
    ...
    if args.test_ds != "":
        ...
        checkpoint(args, model, stats, epoch, split=f"test_{args.test_ds}")